...
const navigationMenuTriggerStyle = cva(cn(
  ...
  "font-medium transition-colors focus:outline-none disabled:opacity-50 disabled:pointer-events-none data-[state=open]:text-orange data-[active]:text-orange h-10 py-2 px-4 group w-max",
))
...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Indicator
    ...
    className={cn(
      ...
      "overflow-hidden",
      "data-[state=visible]:animate-in data-[state=hidden]:animate-out data-[state=visible]:fade-in data-[state=hidden]:fade-out",      className
    )}
    {...props}
  >
